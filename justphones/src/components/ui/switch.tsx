  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        "data-[state=unchecked]:bg-foreground data-[state=checked]:bg-black dark:data-[state=checked]:bg-black",
        thumbClassName
      )}
    />
  </SwitchPrimitives.Root>
