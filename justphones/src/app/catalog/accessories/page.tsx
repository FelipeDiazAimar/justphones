...
function AccessoriesCatalogPageContent() {
  ...
  React.useEffect(() => {
    if (accessoryProducts.length > 0 && filters.priceRange[1] === 100000) {
  ...
  const titleComponent = filters.subCategories.length === 1 ? (
    ...
    <>
      Todos los <span className="text-primary">Accesorios</span>
    </>
  );
